import { R as Rect } from "../../../utilities/geometry.js";
...
function windowRect(node) {
  const document = (node == null ? void 0 : node.ownerDocument) || globalThis.document;
...
export {
  calculateHorizontalPosition as a,
  calculateVerticalPosition as c,
  intersectionWithViewport as i,
  rectIsOutsideOfRect as r,
  windowRect as w
};
